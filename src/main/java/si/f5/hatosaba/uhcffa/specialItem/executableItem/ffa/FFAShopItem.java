...
import si.f5.hatosaba.uhcffa.menu.FFAShopMenu;
import si.f5.hatosaba.uhcffa.specialItem.ExecutableItem;
import si.f5.hatosaba.uhcffa.utils.ItemBuilder;

public class FFAShopItem extends ExecutableItem {

    public FFAShopItem(String id) {
        super(id);
    }
    ...
    public void onClick(PlayerInteractEvent event) {
        ...
        FFAShopMenu.INVENTORY.open(player);
